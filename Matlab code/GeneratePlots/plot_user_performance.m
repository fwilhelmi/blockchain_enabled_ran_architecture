...
fig = figure;
P = [aggtpt(1,1),meansat(1,1),eff(1,1); ...
     aggtpt(2,1),meansat(2,1),eff(2,1);
     aggtpt(3,1),meansat(3,1),eff(3,1)];
P2 = [aggtpt(1,2),meansat(1,2),eff(1,2); ...
     aggtpt(2,2),meansat(2,2),eff(2,2);
     aggtpt(3,2),meansat(3,2),eff(3,2)];
P3 = [aggtpt(1,3),meansat(1,3),eff(1,3); ...
     aggtpt(2,3),meansat(2,3),eff(2,3);
     aggtpt(3,3),meansat(3,3),eff(3,3)];
