...
num_deployments = 5;	% Number of random deployments to be simulated
...
num_operators = [2 4 8];    % Number of operators in the deployment

% Blockchain parameters
block_timeout = 10;             % List of timeouts (in seconds) for generating a block
block_size_spectrum = 2;        % Bock size in number of transactions (spectrum BC)
queue_length = 1000;            % Number of transactions that fit the queue of unconfirmed transactions
lambda = [10];                  % Arrivals rate (UE requests)
