# Blockchain-enabled RAN Sharing for O-RAN in 5G and Beyond#

Resources used to generate the results for the paper "Blockchain-enabled RAN sharing for O-RAN in 5G and Beyond"
...
2. Matlab code: matlab scripts used to process/generate the simulation results together with the "Blockchain-enabled RAN sharing" simulator.
3. Figures: figures used in the paper "Blockchain-enabled RAN Sharing for O-RAN".
